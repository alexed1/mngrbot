...
Pmbot.prototype._showGameMenu = function() {
  var buttonsJson = fs.readFileSync(path.resolve(process.cwd(), 'data', 'falken.json'), 'UTF-8');
  this.postMessageToChannel(this.settings.initChannel, buttonsJson, {as_user: true});
}
