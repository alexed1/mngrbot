...
Pmbot.prototype._showGameMenu = function() {
  var channel = self._getChannelById(this.settings.initChannel);
  var message = require("../data/falken.json");
  console.log(message);
  debugger;
  self.postMessageToChannel(channel.name, JSON.stringify(message), {as_user: true});
}
